...
serve(async (req: Request) => {
  try {
    ...
    try {
      ...
      const whereClause = 'WHERE p.user_id = $1';
      ...
      const userLikedPosts = await getUserLikedPosts(userId, postIds);
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/my_posts' \
